...
import com.dosmil_e.kit.core.projection.behavior.ifc.KitSignaledProjectionIfc;


public class KitSignaledProjectionNMgr extends EAINodeMgr {


  public KitSignaledProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/SignaledProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitSignaledProjection_delete.class
        }
      )
    };
  }
