...
import com.dosmil_e.kit.core.projection.behavior.ifc.KitListenedProjectionIfc;


public class KitListenedProjectionNMgr extends EAINodeMgr {


  public KitListenedProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/ListenedProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitListenedProjection_delete.class
        }
      )
    };
  }
