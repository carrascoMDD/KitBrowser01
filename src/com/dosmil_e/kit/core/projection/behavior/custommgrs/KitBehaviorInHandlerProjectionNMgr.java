...
import com.dosmil_e.kit.core.projection.behavior.ifc.KitBehaviorInHandlerProjectionIfc;


public class KitBehaviorInHandlerProjectionNMgr extends EAINodeMgr {


  public KitBehaviorInHandlerProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/BehaviorInHandlerProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitBehaviorInHandlerProjection_delete.class
        }
      )
    };
  }
