package com.dosmil_e.kit.core.projection.behavior.customconfigs;
...
public class KitBehaviorInHandlerProjectionChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public KitBehaviorInHandlerProjectionChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("Kit").getClassForType( theCtxt, "BehaviorInHandlerProjection", "core.projection.behavior"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("Kit").getClassForType( theCtxt, "BehaviorInHandlerProjection", "core.projection.behavior")));
