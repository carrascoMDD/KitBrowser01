...
public class KitProjection_originals_addChosen_ProjectProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_ProjectProjection(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.projection.organize.customconfigs.KitProjectProjectionChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_ProjectProjection anAction =
      new KitProjection_originals_addChosen_ProjectProjection(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseProjectProjection.gif");
  }
