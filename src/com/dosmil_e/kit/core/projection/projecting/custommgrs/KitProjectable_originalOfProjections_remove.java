...
public class KitProjectable_originalOfProjections_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public KitProjectable_originalOfProjections_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjectable_originalOfProjections_remove anAction =
      new KitProjectable_originalOfProjections_remove(
        getTargetNode());
