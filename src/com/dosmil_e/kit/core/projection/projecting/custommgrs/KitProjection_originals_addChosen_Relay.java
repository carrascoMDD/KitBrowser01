...
public class KitProjection_originals_addChosen_Relay extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_Relay(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_Relay anAction =
      new KitProjection_originals_addChosen_Relay(
      getTargetNode());
