...
import com.dosmil_e.kit.core.projection.projecting.ifc.KitHideIfc;


public class KitHideNMgr extends EAINodeMgr {
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/Hide.gif");
