...
public class KitProjection_originals_addChosen_EnumeratedType extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_EnumeratedType(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.model.structural.customconfigs.KitEnumeratedTypeChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_EnumeratedType anAction =
      new KitProjection_originals_addChosen_EnumeratedType(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseEnumeratedType.gif");
  }
