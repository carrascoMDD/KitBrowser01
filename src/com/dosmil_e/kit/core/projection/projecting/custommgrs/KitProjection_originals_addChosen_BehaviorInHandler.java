...
public class KitProjection_originals_addChosen_BehaviorInHandler extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_BehaviorInHandler(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_BehaviorInHandler anAction =
      new KitProjection_originals_addChosen_BehaviorInHandler(
      getTargetNode());
