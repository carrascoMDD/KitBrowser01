...
public class KitProjection_originals_addChosen_RelayProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_RelayProjection(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_RelayProjection anAction =
      new KitProjection_originals_addChosen_RelayProjection(
      getTargetNode());
