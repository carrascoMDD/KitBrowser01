...
public class KitProjection_originals_addChosen_Alias extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_Alias(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_Alias anAction =
      new KitProjection_originals_addChosen_Alias(
      getTargetNode());
