...
public class KitProjection_originals_addChosen_PortProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_PortProjection(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_PortProjection anAction =
      new KitProjection_originals_addChosen_PortProjection(
      getTargetNode());
