...
public class KitProjection_originals_addChosen_AliasProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_AliasProjection(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_AliasProjection anAction =
      new KitProjection_originals_addChosen_AliasProjection(
      getTargetNode());
