...
public class KitProjection_originals_addChosen_Attribute extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_Attribute(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_Attribute anAction =
      new KitProjection_originals_addChosen_Attribute(
      getTargetNode());
