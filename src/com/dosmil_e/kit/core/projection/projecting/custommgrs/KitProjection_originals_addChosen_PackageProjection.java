...
public class KitProjection_originals_addChosen_PackageProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_PackageProjection(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.projection.organize.customconfigs.KitPackageProjectionChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_PackageProjection anAction =
      new KitProjection_originals_addChosen_PackageProjection(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/choosePackageProjection.gif");
  }
