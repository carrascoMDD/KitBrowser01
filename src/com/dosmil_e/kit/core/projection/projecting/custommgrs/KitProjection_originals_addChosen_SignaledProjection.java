...
public class KitProjection_originals_addChosen_SignaledProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_SignaledProjection(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.projection.behavior.customconfigs.KitSignaledProjectionChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_SignaledProjection anAction =
      new KitProjection_originals_addChosen_SignaledProjection(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseSignaledProjection.gif");
  }
