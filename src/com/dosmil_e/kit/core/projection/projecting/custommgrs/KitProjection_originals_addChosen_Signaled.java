...
public class KitProjection_originals_addChosen_Signaled extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_Signaled(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_Signaled anAction =
      new KitProjection_originals_addChosen_Signaled(
      getTargetNode());
