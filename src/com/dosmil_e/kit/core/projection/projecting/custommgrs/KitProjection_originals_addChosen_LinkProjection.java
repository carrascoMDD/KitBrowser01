...
public class KitProjection_originals_addChosen_LinkProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_LinkProjection(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_LinkProjection anAction =
      new KitProjection_originals_addChosen_LinkProjection(
      getTargetNode());
