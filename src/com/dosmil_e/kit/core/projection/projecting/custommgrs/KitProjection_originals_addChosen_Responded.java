...
public class KitProjection_originals_addChosen_Responded extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitProjection_originals_addChosen_Responded(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.model.behavior.customconfigs.KitRespondedChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_addChosen_Responded anAction =
      new KitProjection_originals_addChosen_Responded(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseResponded.gif");
  }
