...
public class KitProjection_originals_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public KitProjection_originals_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_originals_remove anAction =
      new KitProjection_originals_remove(
        getTargetNode());
