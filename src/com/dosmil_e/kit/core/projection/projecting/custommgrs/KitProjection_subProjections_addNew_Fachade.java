...
public class KitProjection_subProjections_addNew_Fachade extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitProjection_subProjections_addNew_Fachade(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitProjection_subProjections_addNew_Fachade anAction =
      new KitProjection_subProjections_addNew_Fachade( 
        getTargetNode());
