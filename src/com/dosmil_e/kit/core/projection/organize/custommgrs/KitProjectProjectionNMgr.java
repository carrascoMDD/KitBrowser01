...
import com.dosmil_e.kit.core.projection.organize.ifc.KitProjectProjectionIfc;


public class KitProjectProjectionNMgr extends EAINodeMgr {


  public KitProjectProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/ProjectProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitProjectProjection_delete.class
        }
      )
    };
  }
