...
import com.dosmil_e.kit.core.projection.define.ifc.KitLinkProjectionIfc;


public class KitLinkProjectionNMgr extends EAINodeMgr {


  public KitLinkProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/LinkProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitLinkProjection_delete.class
        }
      )
    };
  }
