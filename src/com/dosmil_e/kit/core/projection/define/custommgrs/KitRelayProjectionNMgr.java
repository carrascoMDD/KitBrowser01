...
import com.dosmil_e.kit.core.projection.define.ifc.KitRelayProjectionIfc;


public class KitRelayProjectionNMgr extends EAINodeMgr {


  public KitRelayProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/RelayProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitRelayProjection_delete.class
        }
      )
    };
  }
