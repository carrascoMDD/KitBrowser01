...
import com.dosmil_e.kit.core.projection.define.ifc.KitAliasProjectionIfc;


public class KitAliasProjectionNMgr extends EAINodeMgr {


  public KitAliasProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/AliasProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitAliasProjection_delete.class
        }
      )
    };
  }
