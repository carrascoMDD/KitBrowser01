...
import com.dosmil_e.kit.core.projection.define.ifc.KitComponentProjectionIfc;


public class KitComponentProjectionNMgr extends EAINodeMgr {


  public KitComponentProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/ComponentProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitComponentProjection_delete.class
        }
      )
    };
  }
