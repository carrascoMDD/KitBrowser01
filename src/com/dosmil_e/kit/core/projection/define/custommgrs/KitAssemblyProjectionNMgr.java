...
import com.dosmil_e.kit.core.projection.define.ifc.KitAssemblyProjectionIfc;


public class KitAssemblyProjectionNMgr extends EAINodeMgr {


  public KitAssemblyProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/AssemblyProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitAssemblyProjection_delete.class
        }
      )
    };
  }
