...
import com.dosmil_e.kit.core.projection.structural.ifc.KitEnumeratedTypeProjectionIfc;


public class KitEnumeratedTypeProjectionNMgr extends EAINodeMgr {


  public KitEnumeratedTypeProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/EnumeratedTypeProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitEnumeratedTypeProjection_delete.class
        }
      )
    };
  }
