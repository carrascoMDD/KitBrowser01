...
import com.dosmil_e.kit.core.projection.structural.ifc.KitPrimitiveJavaClassProjectionIfc;


public class KitPrimitiveJavaClassProjectionNMgr extends EAINodeMgr {


  public KitPrimitiveJavaClassProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/PrimitiveJavaClassProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitPrimitiveJavaClassProjection_delete.class
        }
      )
    };
  }
