...
import com.dosmil_e.kit.core.projection.structural.ifc.KitDocumentProjectionIfc;


public class KitDocumentProjectionNMgr extends EAINodeMgr {


  public KitDocumentProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/DocumentProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitDocumentProjection_delete.class
        }
      )
    };
  }
