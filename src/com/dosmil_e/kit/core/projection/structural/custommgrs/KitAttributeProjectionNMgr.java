...
import com.dosmil_e.kit.core.projection.structural.ifc.KitAttributeProjectionIfc;


public class KitAttributeProjectionNMgr extends EAINodeMgr {


  public KitAttributeProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/AttributeProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitAttributeProjection_delete.class
        }
      )
    };
  }
