...
import com.dosmil_e.kit.core.projection.structural.ifc.KitStructuredJavaClassProjectionIfc;


public class KitStructuredJavaClassProjectionNMgr extends EAINodeMgr {


  public KitStructuredJavaClassProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/StructuredJavaClassProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitStructuredJavaClassProjection_delete.class
        }
      )
    };
  }
