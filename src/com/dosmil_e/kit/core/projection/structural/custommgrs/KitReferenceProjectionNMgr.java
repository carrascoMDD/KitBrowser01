...
import com.dosmil_e.kit.core.projection.structural.ifc.KitReferenceProjectionIfc;


public class KitReferenceProjectionNMgr extends EAINodeMgr {


  public KitReferenceProjectionNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/ReferenceProjection.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitReferenceProjection_delete.class
        }
      )
    };
  }
