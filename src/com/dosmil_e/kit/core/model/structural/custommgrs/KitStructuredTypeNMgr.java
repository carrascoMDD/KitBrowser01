...
import com.dosmil_e.kit.core.model.structural.ifc.KitStructuredTypeIfc;


public class KitStructuredTypeNMgr extends EAINodeMgr {


  public KitStructuredTypeNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/StructuredType.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitStructuredType_delete.class
        }
      )
    };
  }
