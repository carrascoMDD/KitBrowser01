...
public class KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_ExposedStructuralFeature extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_ExposedStructuralFeature(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_ExposedStructuralFeature anAction =
      new KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_ExposedStructuralFeature( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createExposedStructuralFeature.gif");
  }
