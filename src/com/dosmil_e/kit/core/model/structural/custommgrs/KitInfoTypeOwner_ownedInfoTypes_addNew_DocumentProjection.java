...
public class KitInfoTypeOwner_ownedInfoTypes_addNew_DocumentProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitInfoTypeOwner_ownedInfoTypes_addNew_DocumentProjection(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitInfoTypeOwner_ownedInfoTypes_addNew_DocumentProjection anAction =
      new KitInfoTypeOwner_ownedInfoTypes_addNew_DocumentProjection( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createDocumentProjection.gif");
  }
