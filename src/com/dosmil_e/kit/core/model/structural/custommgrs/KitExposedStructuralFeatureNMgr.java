...
import com.dosmil_e.kit.core.model.structural.ifc.KitExposedStructuralFeatureIfc;


public class KitExposedStructuralFeatureNMgr extends EAINodeMgr {


  public KitExposedStructuralFeatureNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/ExposedStructuralFeature.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitExposedStructuralFeature_delete.class
        }
      )
    };
  }
