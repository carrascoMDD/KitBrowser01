...
public class KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_AttributeProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_AttributeProjection(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_AttributeProjection anAction =
      new KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_AttributeProjection( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createAttributeProjection.gif");
  }
