...
public class KitInfoTypeOwner_ownedInfoTypes_addNew_BusinessSignal extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitInfoTypeOwner_ownedInfoTypes_addNew_BusinessSignal(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitInfoTypeOwner_ownedInfoTypes_addNew_BusinessSignal anAction =
      new KitInfoTypeOwner_ownedInfoTypes_addNew_BusinessSignal( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createBusinessSignal.gif");
  }
