...
public class KitInfoTypeOwner_ownedInfoTypes_addNew_Document extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitInfoTypeOwner_ownedInfoTypes_addNew_Document(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitInfoTypeOwner_ownedInfoTypes_addNew_Document anAction =
      new KitInfoTypeOwner_ownedInfoTypes_addNew_Document( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createDocument.gif");
  }
