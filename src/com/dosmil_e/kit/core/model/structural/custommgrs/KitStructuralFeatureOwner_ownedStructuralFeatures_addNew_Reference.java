...
public class KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_Reference extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_Reference(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_Reference anAction =
      new KitStructuralFeatureOwner_ownedStructuralFeatures_addNew_Reference( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createReference.gif");
  }
