...
public class KitInfoTypeOwner_ownedInfoTypes_addNew_Content extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitInfoTypeOwner_ownedInfoTypes_addNew_Content(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitInfoTypeOwner_ownedInfoTypes_addNew_Content anAction =
      new KitInfoTypeOwner_ownedInfoTypes_addNew_Content( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createContent.gif");
  }
