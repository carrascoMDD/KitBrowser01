...
import com.dosmil_e.kit.core.model.structural.ifc.KitPrimitiveJavaClassIfc;


public class KitPrimitiveJavaClassNMgr extends EAINodeMgr {


  public KitPrimitiveJavaClassNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/PrimitiveJavaClass.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitPrimitiveJavaClass_delete.class
        }
      )
    };
  }
