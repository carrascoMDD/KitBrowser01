...
public class KitSource_sourceOfAnnnotations_addChosen_Transformation extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitSource_sourceOfAnnnotations_addChosen_Transformation(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.model.trace.customconfigs.KitTransformationChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitSource_sourceOfAnnnotations_addChosen_Transformation anAction =
      new KitSource_sourceOfAnnnotations_addChosen_Transformation(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseTransformation.gif");
  }
