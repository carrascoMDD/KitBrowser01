...
public class KitAnnotation_sources_addChosen_Port extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitAnnotation_sources_addChosen_Port(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitAnnotation_sources_addChosen_Port anAction =
      new KitAnnotation_sources_addChosen_Port(
      getTargetNode());
