...
public class KitAnnotation_sources_addChosen_ProcessType extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitAnnotation_sources_addChosen_ProcessType(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.model.edoc.customconfigs.KitProcessTypeChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitAnnotation_sources_addChosen_ProcessType anAction =
      new KitAnnotation_sources_addChosen_ProcessType(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseProcessType.gif");
  }
