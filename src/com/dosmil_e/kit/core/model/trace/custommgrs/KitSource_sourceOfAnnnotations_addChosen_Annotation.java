...
public class KitSource_sourceOfAnnnotations_addChosen_Annotation extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitSource_sourceOfAnnnotations_addChosen_Annotation(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.model.trace.customconfigs.KitAnnotationChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitSource_sourceOfAnnnotations_addChosen_Annotation anAction =
      new KitSource_sourceOfAnnnotations_addChosen_Annotation(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseAnnotation.gif");
  }
