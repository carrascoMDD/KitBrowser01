...
public class KitComment_attachements_addNew_URL extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitComment_attachements_addNew_URL(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitComment_attachements_addNew_URL anAction =
      new KitComment_attachements_addNew_URL( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createURL.gif");
  }
