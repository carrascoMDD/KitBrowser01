...
public class KitAnnotation_sources_addChosen_PrimitiveProcess extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitAnnotation_sources_addChosen_PrimitiveProcess(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.model.edoc.customconfigs.KitPrimitiveProcessChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitAnnotation_sources_addChosen_PrimitiveProcess anAction =
      new KitAnnotation_sources_addChosen_PrimitiveProcess(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/choosePrimitiveProcess.gif");
  }
