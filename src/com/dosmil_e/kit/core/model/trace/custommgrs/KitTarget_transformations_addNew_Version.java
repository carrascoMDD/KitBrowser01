...
public class KitTarget_transformations_addNew_Version extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitTarget_transformations_addNew_Version(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitTarget_transformations_addNew_Version anAction =
      new KitTarget_transformations_addNew_Version( 
        getTargetNode());
