...
public class KitAnnotation_sources_addChosen_Link extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitAnnotation_sources_addChosen_Link(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitAnnotation_sources_addChosen_Link anAction =
      new KitAnnotation_sources_addChosen_Link(
      getTargetNode());
