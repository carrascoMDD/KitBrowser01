...
public class KitAnnotation_sources_addChosen_Community extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitAnnotation_sources_addChosen_Community(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.model.edoc.customconfigs.KitCommunityChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitAnnotation_sources_addChosen_Community anAction =
      new KitAnnotation_sources_addChosen_Community(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseCommunity.gif");
  }
