...
public class KitAnnotation_sources_addChosen_ExternalRole extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitAnnotation_sources_addChosen_ExternalRole(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.model.edoc.customconfigs.KitExternalRoleChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitAnnotation_sources_addChosen_ExternalRole anAction =
      new KitAnnotation_sources_addChosen_ExternalRole(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseExternalRole.gif");
  }
