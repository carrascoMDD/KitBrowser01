...
public class KitComment_attachements_addNew_Media extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitComment_attachements_addNew_Media(
    com.dosmil_e.browserbase.tree.EAITreeNode theNode) {

    super( theNode,
      com.dosmil_e.kit.core.model.trace.meta.KitCommentMeta.getStaticM3Type( theNode.getMMCtxt()),
      com.dosmil_e.kit.core.model.trace.meta.KitMediaMeta.getStaticM3Type( theNode.getMMCtxt()),
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitComment_attachements_addNew_Media anAction =
      new KitComment_attachements_addNew_Media( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createMedia.gif");
  }
