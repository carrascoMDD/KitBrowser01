...
public class KitAnnotation_sources_addChosen_Resource extends
  com.dosmil_e.browserbase.metamgrs.EAIAddChosenAction {


  public KitAnnotation_sources_addChosen_Resource(
    ...
    super( theNode,
      ...
      com.dosmil_e.kit.core.model.edoc.customconfigs.KitResourceChooserTreeConfigFactory.getConfig( theNode.getMMCtxt())
      );
  }
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitAnnotation_sources_addChosen_Resource anAction =
      new KitAnnotation_sources_addChosen_Resource(
      getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/chooseResource.gif");
  }
