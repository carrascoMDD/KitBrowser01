...
public class KitSource_sourceOfAnnnotations_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public KitSource_sourceOfAnnnotations_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitSource_sourceOfAnnnotations_remove anAction =
      new KitSource_sourceOfAnnnotations_remove(
        getTargetNode());
