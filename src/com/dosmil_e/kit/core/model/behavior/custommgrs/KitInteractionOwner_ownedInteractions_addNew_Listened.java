...
public class KitInteractionOwner_ownedInteractions_addNew_Listened extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitInteractionOwner_ownedInteractions_addNew_Listened(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitInteractionOwner_ownedInteractions_addNew_Listened anAction =
      new KitInteractionOwner_ownedInteractions_addNew_Listened( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createListened.gif");
  }
