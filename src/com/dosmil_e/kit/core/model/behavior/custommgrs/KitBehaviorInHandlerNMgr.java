...
import com.dosmil_e.kit.core.model.behavior.ifc.KitBehaviorInHandlerIfc;


public class KitBehaviorInHandlerNMgr extends EAINodeMgr {


  public KitBehaviorInHandlerNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/BehaviorInHandler.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitBehaviorInHandler_delete.class
        }
      )
    };
  }
