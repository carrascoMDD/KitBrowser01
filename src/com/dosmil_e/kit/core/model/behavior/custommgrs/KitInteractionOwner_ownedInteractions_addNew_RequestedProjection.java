...
public class KitInteractionOwner_ownedInteractions_addNew_RequestedProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitInteractionOwner_ownedInteractions_addNew_RequestedProjection(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitInteractionOwner_ownedInteractions_addNew_RequestedProjection anAction =
      new KitInteractionOwner_ownedInteractions_addNew_RequestedProjection( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createRequestedProjection.gif");
  }
