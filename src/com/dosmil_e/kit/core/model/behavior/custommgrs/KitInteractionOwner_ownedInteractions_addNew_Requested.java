...
public class KitInteractionOwner_ownedInteractions_addNew_Requested extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitInteractionOwner_ownedInteractions_addNew_Requested(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitInteractionOwner_ownedInteractions_addNew_Requested anAction =
      new KitInteractionOwner_ownedInteractions_addNew_Requested( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createRequested.gif");
  }
