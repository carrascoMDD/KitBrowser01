...
public class KitInteractionOwner_ownedInteractions_addNew_Signaled extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitInteractionOwner_ownedInteractions_addNew_Signaled(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitInteractionOwner_ownedInteractions_addNew_Signaled anAction =
      new KitInteractionOwner_ownedInteractions_addNew_Signaled( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createSignaled.gif");
  }
