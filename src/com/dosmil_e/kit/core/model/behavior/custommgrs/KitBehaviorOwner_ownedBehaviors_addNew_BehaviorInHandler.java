...
public class KitBehaviorOwner_ownedBehaviors_addNew_BehaviorInHandler extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitBehaviorOwner_ownedBehaviors_addNew_BehaviorInHandler(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitBehaviorOwner_ownedBehaviors_addNew_BehaviorInHandler anAction =
      new KitBehaviorOwner_ownedBehaviors_addNew_BehaviorInHandler( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createBehaviorInHandler.gif");
  }
