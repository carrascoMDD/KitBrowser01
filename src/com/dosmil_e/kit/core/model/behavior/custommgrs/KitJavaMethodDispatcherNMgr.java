...
import com.dosmil_e.kit.core.model.behavior.ifc.KitJavaMethodDispatcherIfc;


public class KitJavaMethodDispatcherNMgr extends EAINodeMgr {


  public KitJavaMethodDispatcherNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/JavaMethodDispatcher.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitJavaMethodDispatcher_delete.class
        }
      )
    };
  }
