...
public class KitResourceChooserTreeConfigFactory {

  public static EAIConfig     gConfig;
  public static Class         gCtxtClass;

  public KitResourceChooserTreeConfigFactory() {
  }
  ...
  public static EAIConfig initConfig( EAIMMCtxtIfc theCtxt) {
    ...
    EAIClassChooserFilterConfigIfc anOfClassChooserConfig = new EAIClassChooserFilterConfig(
      theCtxt.getMMFactory("Kit").getClassForType( theCtxt, "Resource", "core.model.edoc"),
      new EAIOfClassChooserFilter( theCtxt.getMMFactory("Kit").getClassForType( theCtxt, "Resource", "core.model.edoc")));
