...
import com.dosmil_e.kit.core.model.edoc.ifc.KitPrimitiveProcessIfc;


public class KitPrimitiveProcessNMgr extends EAINodeMgr {


  public KitPrimitiveProcessNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/PrimitiveProcess.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitPrimitiveProcess_delete.class
        }
      )
    };
  }
