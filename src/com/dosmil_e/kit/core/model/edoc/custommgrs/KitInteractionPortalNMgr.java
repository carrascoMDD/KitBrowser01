...
import com.dosmil_e.kit.core.model.edoc.ifc.KitInteractionPortalIfc;


public class KitInteractionPortalNMgr extends EAINodeMgr {


  public KitInteractionPortalNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/InteractionPortal.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitInteractionPortal_delete.class
        }
      )
    };
  }
