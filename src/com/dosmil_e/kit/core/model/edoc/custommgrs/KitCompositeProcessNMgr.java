...
import com.dosmil_e.kit.core.model.edoc.ifc.KitCompositeProcessIfc;


public class KitCompositeProcessNMgr extends EAINodeMgr {


  public KitCompositeProcessNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/CompositeProcess.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitCompositeProcess_delete.class
        }
      )
    };
  }
