...
import com.dosmil_e.kit.core.model.edoc.ifc.KitBusinessSignalIfc;


public class KitBusinessSignalNMgr extends EAINodeMgr {


  public KitBusinessSignalNMgr() {
    super();
  }
  ...
  protected void initIcon() {
    ...
    vIcon = new ImageIcon("images/BusinessSignal.gif");
  ...
  public EAIActionsMgrIfc[] getNodeActionsMgrs( ) {
    return new EAIActionsMgrIfc[] {
      new EAIGenericActionsMgr(
        new Class[] {
//          KitBusinessSignal_delete.class
        }
      )
    };
  }
