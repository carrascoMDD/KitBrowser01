...
public class KitPackageOwner_subPackages_addNew_Package extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitPackageOwner_subPackages_addNew_Package(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitPackageOwner_subPackages_addNew_Package anAction =
      new KitPackageOwner_subPackages_addNew_Package( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createPackage.gif");
  }
