...
public class KitDelegationOwner_ownedDelegations_addNew_AliasProjection extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitDelegationOwner_ownedDelegations_addNew_AliasProjection(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitDelegationOwner_ownedDelegations_addNew_AliasProjection anAction =
      new KitDelegationOwner_ownedDelegations_addNew_AliasProjection( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createAliasProjection.gif");
  }
