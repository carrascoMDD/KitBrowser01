...
public class KitDelegation_delegate_remove extends
  com.dosmil_e.browserbase.metamgrs.EAIRemoveAction {


  public KitDelegation_delegate_remove(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitDelegation_delegate_remove anAction =
      new KitDelegation_delegate_remove(
        getTargetNode());
