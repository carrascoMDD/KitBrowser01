...
public class KitComponentOwner_ownedComponents_addNew_PrimitiveProcess extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitComponentOwner_ownedComponents_addNew_PrimitiveProcess(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitComponentOwner_ownedComponents_addNew_PrimitiveProcess anAction =
      new KitComponentOwner_ownedComponents_addNew_PrimitiveProcess( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createPrimitiveProcess.gif");
  }
