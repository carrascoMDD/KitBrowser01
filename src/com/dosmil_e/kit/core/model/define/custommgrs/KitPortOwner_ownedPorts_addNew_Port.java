...
public class KitPortOwner_ownedPorts_addNew_Port extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitPortOwner_ownedPorts_addNew_Port(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitPortOwner_ownedPorts_addNew_Port anAction =
      new KitPortOwner_ownedPorts_addNew_Port( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createPort.gif");
  }
