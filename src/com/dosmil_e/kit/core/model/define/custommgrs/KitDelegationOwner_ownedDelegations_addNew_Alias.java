...
public class KitDelegationOwner_ownedDelegations_addNew_Alias extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitDelegationOwner_ownedDelegations_addNew_Alias(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitDelegationOwner_ownedDelegations_addNew_Alias anAction =
      new KitDelegationOwner_ownedDelegations_addNew_Alias( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createAlias.gif");
  }
