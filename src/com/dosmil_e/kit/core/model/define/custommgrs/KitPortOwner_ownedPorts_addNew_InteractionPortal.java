...
public class KitPortOwner_ownedPorts_addNew_InteractionPortal extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitPortOwner_ownedPorts_addNew_InteractionPortal(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitPortOwner_ownedPorts_addNew_InteractionPortal anAction =
      new KitPortOwner_ownedPorts_addNew_InteractionPortal( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createInteractionPortal.gif");
  }
