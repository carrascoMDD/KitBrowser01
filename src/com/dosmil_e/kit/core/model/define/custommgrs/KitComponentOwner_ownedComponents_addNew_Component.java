...
public class KitComponentOwner_ownedComponents_addNew_Component extends
  com.dosmil_e.browserbase.metamgrs.EAIAddNewAction {


  public KitComponentOwner_ownedComponents_addNew_Component(
  ...
  public EAIActionIfc cloneBase() throws CloneNotSupportedException {
    KitComponentOwner_ownedComponents_addNew_Component anAction =
      new KitComponentOwner_ownedComponents_addNew_Component( 
        getTargetNode());
  ...
  protected void initIcon() {
    vIcon = new ImageIcon("images/createComponent.gif");
  }
