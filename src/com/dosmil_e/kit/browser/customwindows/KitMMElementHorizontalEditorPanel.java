...
public class KitMMElementHorizontalEditorPanel extends EAIEditorPanel implements DocumentListener, EAIRootChangeListenerIfc {
  ...
  public KitMMElementHorizontalEditorPanel() {
    try  {
      jbInit();
    }
    catch(Exception ex) {
